            ...
            <div class="dt sl dt-sn dt-sn--box border pt-3 pb-5">
              <div class="cart-page cart-empty">
                ...
                <div class="cart-empty-links mb-5">
                  <a href="/test" class="border-bottom-dt">
                    لیست مورد علاقه من
                  </a>
                  <a href="/test" class="border-bottom-dt">
                    محصولات شگفت‌انگیز
                ...
                <a href="/test" class="btn-primary-cm">
            ...
            <div class="col-12">
              <div class="features-checkout-slider carousel-md owl-carousel owl-theme">
                <div class="item">
                  <a href="/test">
                    <img
                      ...
                      alt=""
                    />
                    <div class="title-feature-checkout-slider">
                      تحویل اکسپرس
                    </div>
                  </a>
                </div>
                <div class="item">
                  <a href="/test">
                    <img
                      src="./assets/img/svg/contact-us.svg"
                      class="img-fluid"
                      alt=""
                    />
                    <div class="title-feature-checkout-slider">
                ...
                <div class="item">
                  <a href="/test">
                    <img
                      src="./assets/img/svg/origin-guarantee.svg"
                      class="img-fluid"
                      alt=""
                    />
                    <div class="title-feature-checkout-slider">
