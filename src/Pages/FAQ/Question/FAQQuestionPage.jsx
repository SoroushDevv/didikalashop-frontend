                            ...
                            <div class="row">
                                <div class="col-12 pr-4 mb-3">
                                    <div class="section-title title-wide no-title-wide-before mb-1 no-after-title-wide">
                                        <img src="./assets/img/faq/question.svg" width="30" alt=""/>
                                        <h2 class="font-weight-bold">چطور میتوانم شماره کارت خود را در پروفایلم وارد
                                            کنم؟</h2>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="content-faq-question">
                                        <p>
                                            1.وارد <span>پروفایل</span> خود شوید.
                                        </p>
                                        <img src="./assets/img/faq/question/1.png" alt=""/>
                                        <p>
                                            2.روی کلمه <span>پروفایل</span> کلیک کنید.
                                        </p>
                                        <img src="./assets/img/faq/question/2.png" alt=""/>
                                        <p>
                                            3.روی قسمت <span>ویرایش اطلاعات شخصی</span> کلیک کنید.
                                        </p>
                                        <img src="./assets/img/faq/question/3.png" alt=""/>
                                        <p>
                                            4.شماره کارت خود را وارد نموده و دکمه <span>ثبت</span> را بزنید.
                                        </p>
                                        <img src="./assets/img/faq/question/4.png" alt=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
